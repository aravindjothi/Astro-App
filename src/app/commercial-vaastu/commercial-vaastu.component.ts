...
@Component({
  selector: 'app-commercial-vaastu',
  templateUrl: './commercial-vaastu.component.html',
  styleUrls: ['./commercial-vaastu.component.css']
})
export class CommercialVaastuComponent implements OnInit {
