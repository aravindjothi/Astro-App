...
@Component({
  selector: 'app-residential-vaastu',
  templateUrl: './residential-vaastu.component.html',
  styleUrls: ['./residential-vaastu.component.css']
})
export class ResidentialVaastuComponent implements OnInit {
