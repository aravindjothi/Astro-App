...
@Component({
  selector: 'app-cons-service',
  templateUrl: './cons-service.component.html',
  styleUrls: ['./cons-service.component.css']
})
export class ConsServiceComponent implements OnInit {
