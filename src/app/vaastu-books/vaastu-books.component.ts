...
@Component({
  selector: 'app-vaastu-books',
  templateUrl: './vaastu-books.component.html',
  styleUrls: ['./vaastu-books.component.css']
})
export class VaastuBooksComponent implements OnInit {
