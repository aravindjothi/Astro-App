...
@Component({
  selector: 'app-palmistry-service',
  templateUrl: './palmistry-service.component.html',
  styleUrls: ['./palmistry-service.component.css']
})
export class PalmistryServiceComponent implements OnInit {
