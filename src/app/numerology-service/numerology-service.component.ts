...
@Component({
  selector: 'app-numerology-service',
  templateUrl: './numerology-service.component.html',
  styleUrls: ['./numerology-service.component.css']
})
export class NumerologyServiceComponent implements OnInit {
