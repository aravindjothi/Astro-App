...
@Component({
  selector: 'app-awards-honours',
  templateUrl: './awards-honours.component.html',
  styleUrls: ['./awards-honours.component.css']
})
export class AwardsHonoursComponent implements OnInit {
